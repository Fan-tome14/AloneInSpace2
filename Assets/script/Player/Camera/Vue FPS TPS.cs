...
{
    public Camera playerCamera; // Assigne ta caméra principale ici dans l’inspecteur
    [Header("Layer du corps joueur")]
    [Tooltip("Layer à exclure en vue FPS")]
    public LayerMask playerBodyLayer; // assigné via l’inspecteur (checkbox)
